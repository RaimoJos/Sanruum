...
from sanruum.constants import (BEST_LOG_REG_FILE, BEST_SVM_FILE, MODEL_DIR,
                               PARAMS_FILE, RANDOM_FOREST_MODEL_FILE,
                               RAW_DATA_FILE)
...
print(
    f"Resampled X_train shape: {X_res.shape}, y_train shape: {y_res.shape}"
