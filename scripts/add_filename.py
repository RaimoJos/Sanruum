...
def add_filename_to_file(filepath: str) -> None:
    ...
    relative_path = os.path.relpath(filepath, str(ProjectManager.BASE_DIR))
...
def add_comments_to_all_python_files(base_dir: str) -> None:
...
add_comments_to_all_python_files(str(ProjectManager.BASE_DIR))
